...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieur à la date du jour !", groups={"front"})
     */
    private $startDate;
 ...
 * */
    ...
    public function isBookableDates() {
        // Il faut connaitre les dates qui sont imposibles pour l'annonce
